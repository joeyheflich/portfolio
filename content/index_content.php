<div id="page-content" class="index-content">
<section id="hello" class="dark bg-pixeled hello-section header-buffer padding-bottom-xxl text-medium">
	<div class="row row--hello padding-top-xxl max-width center">
		<h1 class="hello-message">Hi! I'm Joey Heflich - a freelance front-end developer.</h1>
	</div>
...
<section id="youth-outlook" class="featured-section featured-youth-outlook text-medium has-white-background">
	<div class="row row--youth-outlook padding-xxl max-width center clear">
		<div class="featured-column featured-column--1">
			<a href="http://youth-outlook.org" class="featured-image-link block a--no-line"><img src="./images/projects/yo.png" class="featured-image" alt="Youth Outlook Website Screenshots"></a>
		</div>
		<div class="featured-column featured-column--2">
			<h2 class="featured-title heading-medium">Youth Outlook</h2>
			<p class="featured-copy">Youth Outlook needed a redesign to made their site easier to use, both for their staff and the community they support. I worked with them to streamline their content, simplify their posting process and create a custom Wordpress theme that could better convey their organization's message.</p>
			<a href="http://youth-outlook.org" class="button featured-button margin-right-l">View Website</a>
			<a href="<?php echo SITE_URL; ?>projects/#youth-outlook" class="button featured-button">Learn More</a>
		</div>
	</div>
</section>
<section id="erin" class="featured-section featured-erin text-medium has-grey-background">
	<div class="row row--erin padding-xxl max-width center clear">
		<div class="featured-column featured-column--1">
			<a href="http://erindemoss.com" class="featured-image-link block a--no-line"><img src="./images/projects/erin.png" class="featured-image" alt="Erin DeMoss Creative Website Screenshots"></a>
		</div>
		<div class="featured-column featured-column--2">
			<h2 class="featured-title heading-medium">Erin DeMoss Creative</h2>
			<p class="featured-copy">From design to deployment in two weeks, I was able to work with Erin to quickly transform her ideas and .PSDs into a custom Wordpress theme that we can build on as her business changes and grows. Now, she can e-mail me whenever she has a new idea, and the changes will be made by end-of-day.</p>
			<a href="http://erindemoss.com" class="button featured-button margin-right-l">View Website</a>
			<a href="<?php echo SITE_URL; ?>projects/#erin" class="button featured-button">Learn More</a>
		</div>
	</div>
</section>
<section id="kbp" class="featured-section featured-kbp text-medium has-white-background">
	<div class="row row--kbp padding-xxl max-width center clear">
		<div class="featured-column featured-column--1">
			<a href="http://kingbonepress.com" class="featured-image-link block a--no-line"><img src="./images/projects/kbp.png" class="featured-image" alt="King Bone Press Website Screenshots"></a>
		</div>
		<div class="featured-column featured-column--2">
...
<section id="rob" class="featured-section featured-rob text-medium has-grey-background">
	<div class="row row--rob padding-xxl max-width center clear">
		<div class="featured-column featured-column--1">
			<a href="http://roberthafferman.com" class="featured-image-link block a--no-line"><img src="./images/projects/rob.png" class="featured-image" alt="Robert Hafferman Website Screenshots"></a>
		</div>
		<div class="featured-column featured-column--2">
